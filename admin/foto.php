  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="submit" name="edit" class="btn btn-primary">Edit Foto</button>
        </form>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="hapus<?php echo $data['hapusid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
        <button type="submit" name="hapus" class="btn btn-primary">Hapus Foto</button>
        </form>
      </div>
    </div>
  </div>
...
<footer class="d-flex justyfy-content-center border-top mt-3 bg-light fixed-bottom">
